...
class BigDataBRLC(BRLC):
    """ BigDataBRLC is a BRLC to handle large data-sets. Advisable to be used when the number of
        ...
        penalty_param_svm: float (default=0.01)
            ...
            Reference: https://stats.stackexchange.com/questions/31066/what-is-the-influence-of-c-in-svms-with-linear-kernel
        ...
        surrogate_estimator: string (default='SVM')
            Surrogate model to build the initial model for handling large datasets.
